...
| **6c** | On-device QA | **PARTIAL** — Admin PASS (21/21); Manager/Salesman pending credentials |
| **6d** | Release gate | **BLOCKED_PARTIAL_DEVICE_QA_PENDING_ROLES** — monitoring PASS; pending role QA |
