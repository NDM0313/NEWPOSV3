...
| companies_count | 1 |
| pilot_only | true |
| JSON output path | `/root/NEWPOSV3-phase-15-validate/reports/single-core-ledger/tieout-2026-06-23T14-20-51-991Z.json` |
| JSON SHA256 | `144c6d65bf238c5f82f32818a3294d4054d1b09e8f94a35b3b42739d54988cac` |
| Overall status | **PASS** |
