...
**Phase 3B-G Cash Flow finance rule decision pack:** [`phase-3b-g-cash-flow-finance-rule-decision/`](../reports/single-core-ledger/phase-3b-g-cash-flow-finance-rule-decision/) — **prepared** @ 2026-06-29; finance status **PENDING** unless explicit approval exists; DIN CHINA/DIN BRIDAL require Q5/Q4/Q7 decision; no migrations, flags, GL/data mutations, or runtime behavior changes; Cash Flow loader swap remains blocked; BS/P&L finance **PENDING**; R7/R8/next company remain blocked  
...
- **Phase 3B-G Cash Flow finance rule decision pack:** **PREPARED** — finance status **PENDING**; Q4/Q5/Q7 decision form ready; loader swap blocked; no runtime changes — [`phase-3b-g-cash-flow-finance-rule-decision/`](../reports/single-core-ledger/phase-3b-g-cash-flow-finance-rule-decision/)
