...
**Status:** `PHASE 2.14 ROZNAMCHA LOADER FAILED — rolled back to legacy` (Party Ledger loader ON @ `a7a4b727`)  
...
| Roznamcha screen + loader | **OFF** — loader swap rolled back 2026-06-26 (golden parity gate failed) |
