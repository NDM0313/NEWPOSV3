...
**Phase 3B-F Cash Flow row-keyed export / deeper diff tooling:** [`phase-3b-f-cash-flow-row-export/`](../reports/single-core-ledger/phase-3b-f-cash-flow-row-export/) — **implemented** @ 2026-06-29; **diagnostic-only**; no official totals changed; Cash Flow loader swap remains blocked; finance rule confirmation still required for DIN CHINA/DIN BRIDAL; BS/P&L finance **PENDING**; R7/R8/next company remain blocked; deploy pending operator approval  
...
- **Phase 3B-F Cash Flow row-keyed export / deeper diff tooling:** **IMPLEMENTED** — diagnostic/export-only; legacy Cash Flow official unchanged; no official totals changed; Cash Flow loader swap remains blocked; finance rule confirmation still required for DIN CHINA/DIN BRIDAL; BS/P&L finance **PENDING**; R7/R8/next company remain blocked — [`phase-3b-f-cash-flow-row-export/`](../reports/single-core-ledger/phase-3b-f-cash-flow-row-export/)
