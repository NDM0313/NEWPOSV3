...
**Phase 3B-H Cash Flow preview alignment:** [`phase-3b-h-cash-flow-preview-alignment/`](../reports/single-core-ledger/phase-3b-h-cash-flow-preview-alignment/) — **implemented**; finance decisions applied to preview only; official legacy unchanged; loader swap blocked; re-capture after deploy; BS/P&L finance **PENDING**; R7/R8/next company remain blocked  
...
- **Phase 3B-H Cash Flow preview alignment:** **IMPLEMENTED** — preview follows Q4/Q5; legacy official unchanged; loader swap blocked; re-capture after deploy — [`phase-3b-h-cash-flow-preview-alignment/`](../reports/single-core-ledger/phase-3b-h-cash-flow-preview-alignment/)
