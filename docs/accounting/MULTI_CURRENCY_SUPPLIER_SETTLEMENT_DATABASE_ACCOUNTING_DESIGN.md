...
| Wave | Scope |
| --- | --- |
| Wave 0 | Path 21 forensic + role-separated ledgers + Step-1 server idempotency + settlement link lifecycle + Step 2/3 claim-before-pay (**implemented** — `20260811200000_…`, `20260812120000_import_fx_wave0_claim_before_pay.sql`; no pooled tables) |
