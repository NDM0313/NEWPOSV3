...
| 21b | Purchases → **Import FX Cases** (flag ON, W1+W2) | [`ImportFxCaseWorkspace.tsx`](../../src/app/features/import-fx-case/ImportFxCaseWorkspace.tsx) | [`importFxCaseService`](../../src/app/services/importFxCaseService.ts): `create_import_fx_case` / draft / confirm **ARRANGEMENT only** / cancel / link / attachment metadata | `import_fx_cases` + stages/events/links/attachments | n/a | **No JE in W1/W2** | case id | n/a | case_no via `IMPORT_FX_CASE` or IFXC- fallback | none | Session branch | **Non-posting case shell + W2 ARRANGEMENT enrichment; Path 21 unchanged; money stages W3+** |
