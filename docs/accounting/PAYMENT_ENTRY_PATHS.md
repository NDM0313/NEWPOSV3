...
| 21b | Purchases → **Import FX Cases** (flag ON, W1) | [`ImportFxCaseWorkspace.tsx`](../../src/app/features/import-fx-case/ImportFxCaseWorkspace.tsx) | [`importFxCaseService`](../../src/app/services/importFxCaseService.ts): `create_import_fx_case` (+ optional `p_client_operation_id`) / draft / confirm ARRANGEMENT / cancel unposted | `import_fx_cases` + stages/events/links | n/a | **No JE in W1** | case id | n/a | case_no via `IMPORT_FX_CASE` or IFXC- fallback | none | Session branch | **Non-posting case shell; Path 21 unchanged** |
