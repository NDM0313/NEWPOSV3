-- ============================================================================
-- Manual payment/receipt/transfer gap: JEs touching payment account, reference_type manual-like, no payment_id
-- Company: eb71d817-b87e-4195-964b-7b5321b480f5
-- Includes test_transfer (should be canonical manual_payment/manual_receipt).
-- ============================================================================
...
WHERE je.company_id = 'eb71d817-b87e-4195-964b-7b5321b480f5'
  AND LOWER(COALESCE(je.reference_type, '')) IN (
    ...
    'test_manual', 'test_transfer', 'test_customer_receipt'
  )
