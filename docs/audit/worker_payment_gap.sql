-- ============================================================================
-- Worker payment gap: JEs with reference_type worker_payment or test_worker_payment touching payment account but no payment_id
-- Company: eb71d817-b87e-4195-964b-7b5321b480f5
-- These should have a payments row (reference_type = worker_payment) and journal_entries.payment_id set.
-- ============================================================================
...
WHERE je.company_id = 'eb71d817-b87e-4195-964b-7b5321b480f5'
  AND LOWER(COALESCE(je.reference_type, '')) IN ('worker_payment', 'test_worker_payment')
