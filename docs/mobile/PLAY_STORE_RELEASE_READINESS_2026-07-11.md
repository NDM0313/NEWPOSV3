# Play Store Release Readiness â€” OLD ERP Mobile

**Date:** 2026-07-11
**Scope:** `erp-mobile-app/` â€” DIN Collection ERP (`com.dincouture.erp`)
**Status:** Preflight complete â€” **upload not performed**
...
| Salesman extended QA (rows 4â€“20) | **PASS** (2026-07-11 sign-off) |
...
| versionCode bump | Still **39** since 2026-06-08 â€” must increment before upload |
| Salesman extended QA (rows 4â€“20) | **PASS** â€” `reports/salesman-extended-qa-pixel-rows-4-20-20260711/` |
...
| `releases/APK_UPDATE.md` | Last entry 2026-06-08 â€” stale vs audit date |
...
3. `npm run cap:sync:android:prod` â†’ `npm run android:bundle:win`.
...
7. ~~Optionally reconnect Pixel and complete Salesman checklist rows 4â€“20.~~ **Done** (2026-07-11 sign-off).
