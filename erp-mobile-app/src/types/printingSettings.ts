/**
 * Centralized ERP printing settings (ported from web — mobile read-only consumer).
 */
...
export function mergeWithDefaults(
  partial: CompanyPrintingSettings | null | undefined,
): Required<Omit<CompanyPrintingSettings, 'documentTemplates'>> & { documentTemplates: DocumentTemplateId[] } {
  return {
