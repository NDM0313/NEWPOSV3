...
export function accountMatchesProfessionalCategory(
  ...
  if (category === 'asset') {
    if (
      ...
      return true;
    if (c0 === '1') return true;
    if (['1000', '1010', '1020', '1100', '1180', '1050', '1060', '1070', '1080', '1090', '1200'].includes(code))
      return true;
    return false;
  }
...
export type AccountCategory = 'Assets' | 'Liabilities' | 'Equity' | 'Income' | 'Expenses' | 'Cost of Sales';

export function mapDbAccountTypeToOpeningCategory(type: string): AccountCategory {
