                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            <div className="flex items-center gap-2 mb-2">
                              <h4 className="font-semibold text-white">{formatVariationLabel(variation)}</h4>
                            ...
                            <div className="grid grid-cols-3 gap-3 text-sm">
                              <div>
                                ...
                                <p className="font-semibold text-white">Rs. {variation.retailPrice.toLocaleString()}</p>
                              </div>
                              <div>
                              ...
                              <div>
                                ...
                                <p className="font-semibold text-white">Rs. {variation.costPrice.toLocaleString()}</p>
                              </div>
                            </div>
                          </div>
                        </div>
                        {isOutOfStock && (
                          <div className="mt-2 text-xs text-[#EF4444] font-medium">Out of Stock</div>
                        )}
                      </button>
                    );
                  })}
            ...
            <div className="space-y-3">
              <div className="bg-[#111827] rounded-lg p-3">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-semibold text-white">{formatVariationLabel(selectedVariation)}</span>
                </div>
                <div className="flex items-center justify-between text-sm mt-2">
                  <span className="text-[#9CA3AF]">Price:</span>
                  <span className="font-bold text-[#10B981]">Rs. {selectedVariation.retailPrice.toLocaleString()}</span>
                </div>
              </div>
              <button
                type="button"
