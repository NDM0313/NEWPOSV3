...
export function ModuleTogglesSection({ companyId, userId, userRole, profileId }: ModuleTogglesSectionProps) {
  ...
  return (
    <div className="bg-[#1F2937] border border-[#374151] rounded-xl p-4 mb-4">
      ...
      <p className="text-xs text-[#9CA3AF] mb-3">Admin / owner only. Changes apply to all users after sync.</p>
      {error ? <p className="text-sm text-[#FCA5A5] mb-2">{error}</p> : null}
      <div className="rounded-lg border border-[#374151] bg-[#111827] px-3">
        <ToggleRow
