-- Add company_id to all tables that need it
-- Run this after users table has company_id
...
BEGIN
    ...
    -- Add to each table (one at a time to avoid trigger conflicts)
    -- Expenses
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'expenses' AND column_name = 'company_id') THEN
        ...
        EXECUTE format('UPDATE expenses SET company_id = %L WHERE company_id IS NULL', default_company_id);
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'payments' AND column_name = 'company_id') THEN
        ...
        EXECUTE format('UPDATE payments SET company_id = %L WHERE company_id IS NULL', default_company_id);
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'accounting_entries' AND column_name = 'company_id') THEN
        ...
        EXECUTE format('UPDATE accounting_entries SET company_id = %L WHERE company_id IS NULL', default_company_id);
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'branches' AND column_name = 'company_id') THEN
        ...
        EXECUTE format('UPDATE branches SET company_id = %L WHERE company_id IS NULL', default_company_id);
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'contacts' AND column_name = 'company_id') THEN
        ...
        EXECUTE format('UPDATE contacts SET company_id = %L WHERE company_id IS NULL', default_company_id);
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'products' AND column_name = 'company_id') THEN
        ...
        EXECUTE format('UPDATE products SET company_id = %L WHERE company_id IS NULL', default_company_id);
    ...
    -- Sales (be careful with triggers)
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'sales' AND column_name = 'company_id') THEN
        ...
        -- Update in batches to avoid trigger issues
        EXECUTE format('UPDATE sales SET company_id = %L WHERE company_id IS NULL AND id IN (SELECT id FROM sales WHERE company_id IS NULL LIMIT 100)', default_company_id);
        EXECUTE format('UPDATE sales SET company_id = %L WHERE company_id IS NULL', default_company_id);
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'purchases' AND column_name = 'company_id') THEN
        ...
        EXECUTE format('UPDATE purchases SET company_id = %L WHERE company_id IS NULL', default_company_id);
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'rentals' AND column_name = 'company_id') THEN
        ...
        EXECUTE format('UPDATE rentals SET company_id = %L WHERE company_id IS NULL', default_company_id);
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'accounts' AND column_name = 'company_id') THEN
        ...
        EXECUTE format('UPDATE accounts SET company_id = %L WHERE company_id IS NULL', default_company_id);
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'settings' AND column_name = 'company_id') THEN
        ...
        EXECUTE format('UPDATE settings SET company_id = %L WHERE company_id IS NULL', default_company_id);
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'stock_movements' AND column_name = 'company_id') THEN
        ...
        EXECUTE format('UPDATE stock_movements SET company_id = %L WHERE company_id IS NULL', default_company_id);
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'numbering_rules' AND column_name = 'company_id') THEN
        ...
        EXECUTE format('UPDATE numbering_rules SET company_id = %L WHERE company_id IS NULL', default_company_id);
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'permissions' AND column_name = 'company_id') THEN
        ...
        EXECUTE format('UPDATE permissions SET company_id = %L WHERE company_id IS NULL', default_company_id);
