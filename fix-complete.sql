-- ============================================
-- COMPLETE FIX FOR MULTI-TENANT SCHEMA
-- ============================================
-- This fixes all missing columns and creates helper functions
...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE table_schema = 'public' AND table_name = 'expenses' AND column_name = 'company_id'
    ) THEN
        ALTER TABLE expenses ADD COLUMN company_id UUID;
        UPDATE expenses SET company_id = (SELECT id FROM companies WHERE name = 'Din Collection' LIMIT 1) WHERE company_id IS NULL;
...
BEGIN
    IF NOT EXISTS (
        ...
        UPDATE payments SET company_id = (SELECT id FROM companies WHERE name = 'Din Collection' LIMIT 1) WHERE company_id IS NULL;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns 
        WHERE table_schema = 'public' AND table_name = 'accounting_entries' AND column_name = 'company_id'
    ) THEN
        ALTER TABLE accounting_entries ADD COLUMN company_id UUID;
        UPDATE accounting_entries SET company_id = (SELECT id FROM companies WHERE name = 'Din Collection' LIMIT 1) WHERE company_id IS NULL;
...
BEGIN
    IF NOT EXISTS (
        ...
        UPDATE branches SET company_id = (SELECT id FROM companies WHERE name = 'Din Collection' LIMIT 1) WHERE company_id IS NULL;
...
BEGIN
    IF NOT EXISTS (
        ...
        UPDATE contacts SET company_id = (SELECT id FROM companies WHERE name = 'Din Collection' LIMIT 1) WHERE company_id IS NULL;
...
BEGIN
    IF NOT EXISTS (
        ...
        UPDATE products SET company_id = (SELECT id FROM companies WHERE name = 'Din Collection' LIMIT 1) WHERE company_id IS NULL;
...
BEGIN
    IF NOT EXISTS (
        ...
        UPDATE sales SET company_id = (SELECT id FROM companies WHERE name = 'Din Collection' LIMIT 1) WHERE company_id IS NULL;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns 
        WHERE table_schema = 'public' AND table_name = 'purchases' AND column_name = 'company_id'
    ) THEN
        ALTER TABLE purchases ADD COLUMN company_id UUID;
        UPDATE purchases SET company_id = (SELECT id FROM companies WHERE name = 'Din Collection' LIMIT 1) WHERE company_id IS NULL;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns 
        WHERE table_schema = 'public' AND table_name = 'rentals' AND column_name = 'company_id'
    ) THEN
        ALTER TABLE rentals ADD COLUMN company_id UUID;
        UPDATE rentals SET company_id = (SELECT id FROM companies WHERE name = 'Din Collection' LIMIT 1) WHERE company_id IS NULL;
...
BEGIN
    IF NOT EXISTS (
        ...
        UPDATE accounts SET company_id = (SELECT id FROM companies WHERE name = 'Din Collection' LIMIT 1) WHERE company_id IS NULL;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns 
        WHERE table_schema = 'public' AND table_name = 'settings' AND column_name = 'company_id'
    ) THEN
        ALTER TABLE settings ADD COLUMN company_id UUID;
        UPDATE settings SET company_id = (SELECT id FROM companies WHERE name = 'Din Collection' LIMIT 1) WHERE company_id IS NULL;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns 
        WHERE table_schema = 'public' AND table_name = 'stock_movements' AND column_name = 'company_id'
    ) THEN
        ALTER TABLE stock_movements ADD COLUMN company_id UUID;
        UPDATE stock_movements SET company_id = (SELECT id FROM companies WHERE name = 'Din Collection' LIMIT 1) WHERE company_id IS NULL;
...
BEGIN
    IF NOT EXISTS (
        ...
        UPDATE users SET company_id = (SELECT id FROM companies WHERE name = 'Din Collection' LIMIT 1) WHERE company_id IS NULL;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns 
        WHERE table_schema = 'public' AND table_name = 'numbering_rules' AND column_name = 'company_id'
    ) THEN
        ALTER TABLE numbering_rules ADD COLUMN company_id UUID;
        UPDATE numbering_rules SET company_id = (SELECT id FROM companies WHERE name = 'Din Collection' LIMIT 1) WHERE company_id IS NULL;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns 
        WHERE table_schema = 'public' AND table_name = 'permissions' AND column_name = 'company_id'
    ) THEN
        ALTER TABLE permissions ADD COLUMN company_id UUID;
        UPDATE permissions SET company_id = (SELECT id FROM companies WHERE name = 'Din Collection' LIMIT 1) WHERE company_id IS NULL;
