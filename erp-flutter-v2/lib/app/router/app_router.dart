...
String _shellPath(String location) {
...
Widget _withShell(GoRouterState state, Widget child) {
  final path = _shellPath(state.matchedLocation);
  final showShell = path == '/home' ||
      path == '/sales' ||
      path == '/pos' ||
      path == '/contacts';
  if (!showShell) return child;
  return MainShell(currentPath: state.matchedLocation, child: child);
}
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) =>
            _withShell(state, const HomeScreen()),
      ),
      GoRoute(
        path: '/contacts',
        builder: (context, state) =>
            _withShell(state, const ContactsListScreen()),
        routes: [
          GoRoute(
            path: 'new',
      ...
      GoRoute(
        path: '/sales',
        builder: (context, state) =>
            _withShell(state, const SalesListScreen()),
        routes: [
          GoRoute(
            path: 'new',
      ...
      GoRoute(
        path: '/pos',
        builder: (context, state) => _withShell(state, const PosScreen()),
      ),
      GoRoute(
        path: '/settings',
