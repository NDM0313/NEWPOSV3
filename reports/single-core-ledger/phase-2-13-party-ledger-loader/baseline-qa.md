# Phase 2.13 Party Ledger loader QA — baseline

**Overall:** PASS

- [PASS] admin login
- [PASS] Party Ledger main loader (baseline) — expected=legacy actual=legacy
...
- [PASS] legacy golden captured — closing=216300
