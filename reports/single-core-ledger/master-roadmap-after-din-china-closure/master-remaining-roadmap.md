...
- **Phase 3B-D Cash Flow candidate golden capture** — DIN CHINA · DIN BRIDAL · DIN COUTURE; values **candidate-only, not finance approved**; Cash Flow loader swap not approved; BS/P&L finance **PENDING**; no migrations/flags/GL mutations — [`phase-3b-d-cash-flow-golden-capture/`](../phase-3b-d-cash-flow-golden-capture/)
