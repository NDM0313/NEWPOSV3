...
| T14J | Cash Flow residual delta bridge (Phase 3B-J) | **COMPLETE — PREPARED** | [`phase-3b-j-cash-flow-residual-delta-bridge/`](../phase-3b-j-cash-flow-residual-delta-bridge/) — finance basis decision required; no deploy |
