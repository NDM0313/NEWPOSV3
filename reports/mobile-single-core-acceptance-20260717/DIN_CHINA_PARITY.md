...
| Dashboard/contact GL totals | **PASS** | 13025647.98 | 1140286.4 | — | — | — | `get_contact_party_gl_balances` |
| Contact list vs customer statement closing | **EXPECTED_BASIS_DIFFERENCE** | 13025647.98 | 1140286.4 | — | — | — | `get_contact_party_gl_balances` |
| Operational Aging | **EXPECTED_BASIS_DIFFERENCE** | — | — | — | — | — | `operational_due_amount` |
| Genuine zero/no-activity customer | **PASS** | 1319586 | 1319586 | 0 | 0 | 0 | `get_unified_party_ledger` |
| Account Ledger / Ledger V2 / BS / PL (control) | **PASS** | — | — | 394526434.15 | 394526434.15 | 57 | `get_unified_trial_balance` |
...
- **Contact list vs customer statement closing**: Contact list is as-of GL; Party Ledger closing is period-scoped (same company-wide null branch) HASSAN   MARDAN
