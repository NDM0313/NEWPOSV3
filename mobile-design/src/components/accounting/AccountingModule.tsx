...
export function AccountingModule({ onBack, user }: AccountingModuleProps) {
        ...
        <div className="bg-[#1F2937] border-b border-[#374151] p-4 sticky top-0 z-10">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full h-10 bg-[#111827] border border-[#374151] rounded-lg pl-10 pr-4 text-sm focus:outline-none focus:border-[#3B82F6]"
            />
          </div>
        </div>
            ...
            >
              <div className="flex items-start justify-between mb-2">
                <div>
                  ...
                  <h3 className="font-medium mt-1">{account.name}</h3>
                </div>
      ...
      <div className="min-h-screen pb-24">
        ...
        <div className="bg-[#1F2937] border-b border-[#374151] p-4 sticky top-0 z-10">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <h1 className="font-semibold">Journal Entries</h1>
      ...
      <div className="min-h-screen pb-24">
        ...
        <div className="bg-[#1F2937] border-b border-[#374151] p-4 sticky top-0 z-10">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <h1 className="font-semibold">Financial Reports</h1>
    ...
    <div className="min-h-screen pb-24">
      ...
      <div className="bg-gradient-to-br from-[#F59E0B] to-[#D97706] p-4 sticky top-0 z-10">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div className="flex-1">
            <h1 className="font-semibold">Accounting</h1>
