...
export const BusinessHealthGrid: React.FC<Props> = ({ snapshot, showMoney }) => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
      ...
      <Card
        title="Purchases"
        amount={summary.periodPurchases}
      ...
      <Card
        ...
        amount={summary.periodOperatingExpenses}
