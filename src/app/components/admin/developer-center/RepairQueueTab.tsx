        ...
        <>
          <Card className="border-gray-800 bg-gray-900/40">
            <CardHeader>
              ...
              <CardDescription>Read-only previews — apply via Developer Integrity Lab unless Phase E action below.</CardDescription>
            </CardHeader>
          ...
          <Card className="border-gray-800 bg-gray-900/40">
            <CardHeader>
              ...
              <CardDescription>Preview from numberingMaintenanceService.analyze — never decreases counters.</CardDescription>
            </CardHeader>
          ...
          {selectedDocType && outOfSync.some((r) => r.documentType === selectedDocType) && (
            <Card className="border-amber-900/40 bg-amber-950/10">
              <CardHeader>
                <CardTitle className="text-base">Phase E — Confirm sequence sync</CardTitle>
                <CardDescription>
