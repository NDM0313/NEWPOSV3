...
export const PurchaseReturnPrintLayout: React.FC<PurchaseReturnPrintLayoutProps> = ({ purchaseReturn, onClose }) => {
  ...
  const headerMeta = [
    { label: 'Return No', value: purchaseReturn.return_no || purchaseReturn.id?.slice(0, 8) || 'N/A' },
    { label: 'Date', value: new Date(purchaseReturn.return_date || purchaseReturn.created_at).toLocaleDateString() },
    { label: 'Original PO', value: purchaseReturn.original_purchase_no || 'N/A' },
    { label: 'Status', value: purchaseReturn.status === 'final' ? 'FINAL' : 'DRAFT' },
  ];
      ...
      <div className="classic-print-section">
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '32px', marginBottom: '24px' }}>
          <div>
            ...
            <p style={{ fontSize: '11px', marginBottom: '4px' }}>{purchaseReturn.supplier_name || 'N/A'}</p>
          </div>
          <div>
