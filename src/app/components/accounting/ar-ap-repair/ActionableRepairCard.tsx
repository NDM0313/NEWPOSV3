  ...
  if (compact) {
    return (
      <div className="flex flex-col gap-1 min-w-[140px]">
        ...
        <span className="text-[10px] text-muted-foreground line-clamp-2" title={c.issueType}>
          {c.issueType}
        </span>
        {c.effectiveImpact ? (
        ...
        {c.auditImpact ? (
          <span className="text-[10px] text-muted-foreground line-clamp-1" title={c.auditImpact}>
            Audit: {c.auditImpact}
          </span>
        ) : null}
        <Button
      ...
      <DetailRow
        ...
        value={
          c.whatWillChange.length ? (
            ...
            <span className="text-muted-foreground">Nothing (view/mark only)</span>
          )
        }
      />
      <DetailRow
