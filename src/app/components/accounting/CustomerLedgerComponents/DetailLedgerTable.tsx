  ...
  groupedEntries.groups.forEach((saleEntries, saleId) => {
    ...
    rows.push(
      ...
      >
        ...
        <td className="px-4 py-3 text-sm text-muted-foreground">Sale Invoice</td>
        <td className="px-4 py-3 text-sm text-muted-foreground">-</td>
        <td className="px-4 py-3 text-sm text-muted-foreground">-</td>
        <td className="px-4 py-3 text-sm text-foreground font-semibold">Sale Invoice</td>
        ...
        <td className="px-4 py-3 text-sm text-right tabular-nums text-muted-foreground">-</td>
        <td className="px-4 py-3 text-sm text-right tabular-nums font-semibold text-muted-foreground">
    ...
    if (isExpanded && saleDetail) {
      ...
      if (subtotal > 0) {
        rows.push(
          <tr key={`sale-${saleId}-subtotal`} className="bg-muted/30 border-b border-border">
            ...
            <td className="px-4 py-2 text-xs text-muted-foreground">-</td>
            <td className="px-4 py-2 text-xs text-muted-foreground">-</td>
            <td className="px-4 py-2 text-xs text-muted-foreground pl-8">Items Total</td>
      ...
      if (expenses > 0) {
        rows.push(
          <tr key={`sale-${saleId}-expenses`} className="bg-muted/30 border-b border-border">
            <td className="px-4 py-2"></td>
            <td className="px-4 py-2"></td>
            <td className="px-4 py-2"></td>
            <td className="px-4 py-2 text-xs text-muted-foreground">-</td>
            <td className="px-4 py-2 text-xs text-muted-foreground">-</td>
            <td className="px-4 py-2 text-xs text-muted-foreground">-</td>
            <td className="px-4 py-2 text-xs text-muted-foreground pl-8">Extra Charges</td>
            <td className="px-4 py-2 text-xs text-right text-muted-foreground">
      ...
      if (discount > 0) {
        rows.push(
          <tr key={`sale-${saleId}-discount`} className="bg-muted/30 border-b border-border">
            <td className="px-4 py-2"></td>
            <td className="px-4 py-2"></td>
            <td className="px-4 py-2"></td>
            <td className="px-4 py-2 text-xs text-muted-foreground">-</td>
            <td className="px-4 py-2 text-xs text-muted-foreground">-</td>
            <td className="px-4 py-2 text-xs text-muted-foreground">-</td>
            <td className="px-4 py-2 text-xs text-muted-foreground pl-8">Discount</td>
            <td className="px-4 py-2 text-xs text-right text-muted-foreground">-</td>
      ...
      saleEntries.forEach((entry, idx) => {
        ...
        rows.push(
          ...
          >
            <td className="px-4 py-2"></td>
            <td className="px-4 py-2 text-sm text-muted-foreground pl-8">
            ...
            <td className="px-4 py-2 text-xs text-muted-foreground">{entry.document_type || entry.source_module}</td>
            <td className="px-4 py-2 text-xs text-muted-foreground">{entry.account_name || '-'}</td>
            <td className="px-4 py-2 text-xs text-muted-foreground">{entry.description}</td>
            ...
            <td className="px-4 py-2 text-xs text-right tabular-nums font-semibold text-muted-foreground">
  ...
  groupedEntries.standalone.forEach((entry, idx) => {
    rows.push(
      ...
      >
        ...
        <td className="px-4 py-3 text-sm text-muted-foreground">{entry.document_type || entry.source_module}</td>
        <td className="px-4 py-3 text-sm text-muted-foreground">{entry.account_name || '-'}</td>
