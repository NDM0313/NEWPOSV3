...
export const SalesEntry = () => {
  ...
  const getShippingStatusConfig = (status: ShippingStatus) => {
    const configs = {
      pending: { label: 'Pending', color: 'bg-gray-500/10 text-muted-foreground border-gray-500/20', icon: Clock, iconColor: 'text-muted-foreground' },
      ...
      delivered: { label: 'Delivered', color: 'bg-green-500/10 text-[var(--erp-money-positive)] border-green-500/20', icon: CheckCircle, iconColor: 'text-[var(--erp-money-positive)]' },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-foreground">Sales Transactions</h2>
          <p className="text-muted-foreground dark:text-muted-foreground">Manage sales orders and shipping status</p>
        </div>
        <div className="flex gap-3">
          <Button variant="outline" className="gap-2 border-gray-200 dark:border-border text-gray-700 dark:text-gray-200">
            <Filter size={16} />
            Filter
          </Button>
          <Button variant="outline" className="gap-2 border-gray-200 dark:border-border text-gray-700 dark:text-gray-200">
      ...
      <div className="grid grid-cols-7 gap-3">
        ...
        >
          <div className="text-2xl font-bold text-foreground">{stats.all}</div>
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <div className="text-2xl font-bold text-foreground">{stats.packed}</div>
          </div>
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <div className="text-2xl font-bold text-foreground">{stats.dispatched}</div>
          </div>
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <div className="text-2xl font-bold text-foreground">{stats['in-transit']}</div>
          </div>
        ...
        >
          <div className="flex items-center gap-2">
            <CheckCircle size={16} className="text-[var(--erp-money-positive)]" />
                    ...
                    <tr className="hover:bg-accent/30 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="start" className="bg-card border-border text-foreground w-48">
                            <DropdownMenuItem 
                            ...
                            >
                              <CheckCircle size={14} className="mr-2 text-[var(--erp-money-positive)]" />
                              Delivered
                            </DropdownMenuItem>
                            <DropdownMenuItem 
                              className="hover:bg-muted cursor-pointer focus:bg-muted"
                      ...
                      <td className="px-6 py-4 text-right font-bold text-foreground">{sale.amount}</td>
                    </tr>
                        ...
                        <td colSpan={8} className="px-6 py-4">
                          <div className="grid grid-cols-3 gap-4 p-4 bg-muted/40 rounded-lg border border-border">
                            ...
                            <div className="space-y-2">
                              ...
                              <p className="text-sm text-foreground">{sale.shippingAddress || 'N/A'}</p>
                            </div>
                            ...
                            <div className="space-y-2">
                              ...
                              <p className="text-sm text-foreground">{sale.phone || 'N/A'}</p>
                            ...
                            <div className="space-y-2">
                              ...
                              {sale.shippingDate && (
                                <div className="flex justify-between text-sm">
                                  ...
                                  <span className="text-foreground">{sale.shippingDate}</span>
                                </div>
                              )}
                              {sale.deliveryDate && (
                                <div className="flex justify-between text-sm">
                                  <span className="text-muted-foreground">Delivered:</span>
                                  <span className="text-[var(--erp-money-positive)]">{sale.deliveryDate}</span>
                                </div>
                              )}
                              {!sale.shippingDate && !sale.deliveryDate && (
                                <span className="text-sm text-muted-foreground">No dates recorded</span>
                              )}
                            </div>
                          </div>
                        </td>
