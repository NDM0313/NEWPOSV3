    ...
    <div className="min-h-screen bg-gray-950 text-white animate-in fade-in duration-500">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-6">
        <div className="flex flex-col md:flex-row gap-6 min-h-[calc(100vh-8rem)]">
          <aside className="md:w-60 shrink-0 md:border-r md:border-gray-800 md:pr-4">
              ...
              {categories.map((category) => {
                ...
                return (
                  <div key={category.id} className="rounded-lg border border-transparent">
                    ...
                    {isExpanded ? (
                      <ul className="mt-0.5 mb-2 ml-2 pl-2 border-l border-gray-800 space-y-0.5">
                          ...
                          return (
                            <li key={item.id}>
                              ...
                              >
                                ...
                                {selected ? <ChevronRight size={14} className="shrink-0 text-blue-400" /> : null}
                              </button>
                            </li>
                          );
                        })}
          ...
          <main className="flex-1 min-w-0">
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-4 md:p-6 space-y-8">
              {children}
            </div>
          </main>
        </div>
