...
export function StaffAndPayrollTab() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Global defaults */}
      <section className="bg-gray-900/50 border border-gray-800 rounded-xl p-6 space-y-5">
        <div className="flex items-center gap-2">
          <Settings2 className="w-5 h-5 text-purple-400" />
          <h3 className="text-lg font-semibold text-white">Default Payroll Settings</h3>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-2">
            <Label className="text-gray-300">Salary generation day (monthly)</Label>
            <Input
              type="number"
              min={1}
              max={31}
              ...
              className="bg-gray-800 border-gray-700 text-white max-w-[120px]"
            />
            <p className="text-xs text-gray-500">{formatGenerationDayHint(defaults.generationDay)}</p>
            <p className="text-xs text-gray-400 flex items-center gap-1 mt-2">
              <Calendar className="w-3.5 h-3.5" />
              This month ({previewYear}-{String(previewMonth).padStart(2, '0')}): prepares on day{' '}
              <span className="font-semibold text-white">{effectiveDayThisMonth}</span>
            </p>
          </div>

          <div className="space-y-2">
            <Label className="text-gray-300">Default payment account</Label>
            <Select
            ...
            <p className="text-xs text-gray-500">Used in Phase 5 when salary payment is enabled.</p>
          </div>

          <div className="space-y-2">
            <Label className="text-gray-300">Salary expense account code</Label>
            <Input
          ...
          <div className="space-y-2">
            <Label className="text-gray-300">Commission expense account code</Label>
            <Input
          ...
          <div className="space-y-2">
            <Label className="text-gray-300">Staff payable account code</Label>
            <Input
        ...
        <div className="flex flex-wrap gap-4 pt-2">
          <div className="flex items-center gap-2">
            ...
            />
            <span className="text-sm text-gray-400">Require approval before GL post (Phase 4)</span>
          </div>
          <div className="flex items-center gap-2">
            <Switch
            ...
            />
            <span className="text-sm text-gray-400">Require approval before pay (Phase 5)</span>
          </div>
        </div>
      ...
      <section className="bg-gray-900/50 border border-gray-800 rounded-xl overflow-hidden">
        <div className="p-6 border-b border-gray-800 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-lg font-semibold text-white">Staff Salary Settings</h3>
          </div>
        ...
        {backfillResult != null && (
          <p className="px-6 py-2 text-xs text-gray-500 border-b border-gray-800">
        ...
        <Table>
          ...
          <TableBody>
            {loading ? (
              ...
              staffRows.map((row) => (
                <TableRow key={row.user_id} className="hover:bg-gray-800/30">
                  <TableCell>
      ...
      <Dialog open={addOpen} onOpenChange={setAddOpen}>
        <DialogContent className="bg-gray-900 border-gray-800 text-white">
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => setAddOpen(false)} className="border-gray-700">
              Cancel
            </Button>
