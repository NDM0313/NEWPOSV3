    ...
    <div className="space-y-6 animate-in slide-in-from-bottom-2 duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-gradient-to-br from-gray-900 to-green-900/20 border border-green-900/30 p-6 rounded-xl relative overflow-hidden">
          <div className="relative z-10">
            <p className="text-muted-foreground font-medium text-sm">Most Profitable Customer</p>
            <h3 className="text-xl font-bold text-foreground mt-1">Bridal Boutique Lahore</h3>
            <p className="text-[var(--erp-money-positive)] text-sm mt-2 font-mono font-bold">+Rs 650,000 Profit</p>
          </div>
        ...
        <div className="bg-gradient-to-br from-gray-900 to-blue-900/20 border border-blue-900/30 p-6 rounded-xl relative overflow-hidden">
          <div className="relative z-10">
            <p className="text-muted-foreground font-medium text-sm">Highest Margin (Retail)</p>
            <h3 className="text-xl font-bold text-foreground mt-1">Mrs. Saad</h3>
        ...
        <div className="bg-card border border-border p-6 rounded-xl flex flex-col justify-center">
          <div className="relative w-full">
            ...
            <Input 
              ...
              className="pl-10 bg-input-background border-border text-foreground h-12 w-full"
            />
          </div>
        </div>
      </div>
      ...
      <div className="bg-card border border-border rounded-xl overflow-hidden">
                ...
                <tr key={row.id} className="hover:bg-accent/30 transition-colors group">
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      <div className="h-8 w-8 rounded-full bg-muted flex items-center justify-center text-xs font-bold text-muted-foreground group-hover:bg-blue-900/50 group-hover:text-blue-400 transition-colors">
                  ...
                  <td className="px-6 py-4 text-right font-mono">
                    <span className={cn(
                      ...
                      row.margin >= 30 ? "bg-green-500/20 text-[var(--erp-money-positive)]" : 
        ...
        <div className="p-4 border-t border-border bg-card text-center">
          <p className="text-muted-foreground text-sm">Showing top 6 customers based on profitability</p>
        </div>
      </div>
    </div>
  );
