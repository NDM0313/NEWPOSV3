import type { DefaultAccounts } from '@/app/context/SettingsContext';
...
/** Mirror mobile UnifiedPaymentDialog / MobilePaymentSheet default account resolution. */
export function resolveDefaultPaymentAccountId(
  method: PaymentMethod,
  filteredAccounts: PaymentAccountPick[],
  defaultAccounts: DefaultAccounts | null,
