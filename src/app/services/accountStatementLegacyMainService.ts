/**
 * Account Statement — legacy main loader (extracted from AccountLedgerReportPage).
 * Used for default main table and legacy shadow preview compare.
 */
...
export async function loadAccountStatementLegacyMain(
