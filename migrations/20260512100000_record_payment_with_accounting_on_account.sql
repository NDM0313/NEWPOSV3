-- ============================================================================
-- record_payment_with_accounting: on_account supplier / customer payments
-- ============================================================================
-- Extends duplicate-proof RPC (20260511120000): party sub-ledgers without a
-- linked sale/purchase row. Callers pass reference_type = 'on_account' and
-- p_reference_id = contact UUID (customer for received, supplier for paid).
