-- Include sales_items.customization_details in generate_invoice_document items JSON
-- so printed invoices can show base / materials / customization charge breakdown.
...
COMMENT ON FUNCTION generate_invoice_document(UUID) IS 'Invoice document JSON; items include customization_details when column exists for bespoke print breakdown.';
