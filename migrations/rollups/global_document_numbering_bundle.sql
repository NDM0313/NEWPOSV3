-- ============================================================================
-- BUNDLE: global document numbering (paste entire file in SQL Editor)
-- Sources: migrations/20260513120000_global_document_numbering_rpcs.sql
--          migrations/20260513120001_generate_document_number_studio_sales_order_heal.sql
--          migrations/20260515120000_fix_create_rental_booking_rental_status.sql
-- ============================================================================
  ...
  LOOP
    ...
    BEGIN
      ...
      VALUES (
        ...
        st::TEXT,
        COALESCE(NULLIF(TRIM(p->>'payment_status'), ''), 'unpaid')::TEXT,
...
-- ============================================================================
-- STUDIO numbering self-heal: include sales.order_no (studio orders) alongside
-- studio_productions.production_no so concurrent STD-* allocation cannot diverge.
-- Apply after 20260513120000_global_document_numbering_rpcs.sql
-- ============================================================================
...
COMMENT ON FUNCTION public.generate_document_number(UUID, UUID, TEXT, BOOLEAN) IS
  'ERP numbering v3: self-healing; STUDIO observes studio_productions + studio sales.order_no; JV/FT 6-digit padding.';
