-- Persist sales_items.customization_details on line-item replace (mobile RPC + parity with web).
-- Additive: extends update_sale_with_items INSERT from 20260510; does not change purchase RPC.
...
BEGIN
    ...
    LOOP
        ...
        IF v_tbl = 'sales_items' THEN
            IF v_sale_items_has_custom THEN
