...
export function SalesHome({ onBack, onNewSale }: SalesHomeProps) {
  return (
    <div className="min-h-screen bg-[#111827]">
            ...
            {recentSales.map((sale) => (
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <span className="font-medium text-[#F9FAFB]">{sale.id}</span>
      ...
      <button
        onClick={onNewSale}
        className="fixed bottom-20 right-6 w-14 h-14 bg-[#3B82F6] hover:bg-[#2563EB] rounded-full shadow-lg shadow-[#3B82F6]/30 flex items-center justify-center active:scale-95 transition-all"
      >
