...
import { ArrowLeft, Search, Plus, X, Wallet, TrendingUp } from 'lucide-react';
...
export function SelectAccountTablet({ 
  ...
  const CompactAccountCard = ({ account }: { account: Account }) => {
    const getTypeColor = (type: string) => {
      switch(type) {
        case 'Asset': return 'text-[#10B981] bg-[#10B981]/10';
        case 'Liability': return 'text-[#EF4444] bg-[#EF4444]/10';
        case 'Expense': return 'text-[#F59E0B] bg-[#F59E0B]/10';
        case 'Revenue': return 'text-[#3B82F6] bg-[#3B82F6]/10';
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="text-right flex-shrink-0">
            ...
            <p className={`text-sm font-semibold ${account.balance >= 0 ? 'text-[#10B981]' : 'text-[#EF4444]'}`}>
    ...
    <div className="min-h-screen bg-[#111827]">
        ...
        <div className="max-w-4xl mx-auto px-6 py-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full h-12 bg-[#111827] border border-[#374151] rounded-lg pl-11 pr-4 text-sm focus:outline-none focus:border-[#F59E0B] focus:ring-2 focus:ring-[#F59E0B]/20 transition-all"
            />
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-6">
        <div className="grid grid-cols-3 gap-6">
          {/* Left Column - Account List (2/3 width) */}
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full h-12 bg-[#111827] border border-[#374151] rounded-lg px-4 focus:outline-none focus:border-[#F59E0B] focus:ring-2 focus:ring-[#F59E0B]/20"
                />
              </div>
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  ...
                  className="flex-1 h-12 bg-[#F59E0B] hover:bg-[#D97706] disabled:bg-[#374151] disabled:text-[#6B7280] rounded-lg font-medium transition-colors"
                >
                  Add Account
                </button>
              </div>
