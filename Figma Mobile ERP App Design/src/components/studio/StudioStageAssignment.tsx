...
import { StudioStage } from './StudioDashboard';
...
export function StudioStageAssignment({ onBack, onComplete, existingStage }: StudioStageAssignmentProps) {
  ...
  return (
    <div className="min-h-screen pb-24 bg-[#111827]">
      ...
      <div className="bg-gradient-to-br from-[#8B5CF6] to-[#7C3AED] p-4 sticky top-0 z-10">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div className="flex-1">
            <h1 className="font-semibold">{existingStage ? 'Edit Stage' : 'Add Production Stage'}</h1>
      ...
      <div className="p-4">
        ...
        {step === 1 && (
          <div>
            <h2 className="text-lg font-semibold mb-2">Select Stage Type</h2>
        ...
        {step === 3 && (
          <div>
            <h2 className="text-lg font-semibold mb-2">Assign to Worker</h2>
        ...
        {step === 4 && (
          <div>
            <h2 className="text-lg font-semibold mb-2">Cost & Pricing</h2>
            ...
            <div className="space-y-5">
              ...
              <div className="bg-gradient-to-br from-[#1F2937] to-[#111827] border border-[#374151] rounded-xl p-4">
                ...
                {/* Customer Charge Input - Shows when enabled */}
                {hasCustomerCharge && (
              ...
              {/* Profit Margin - Only shows if customer charge is added */}
              {hasCustomerCharge && internalCost && customerCharge && parseFloat(customerCharge) > 0 && (
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="text-right">
                      ...
                      <p className={`text-lg font-semibold ${
                        ...
                        {((parseFloat(customerCharge) - parseFloat(internalCost)) / parseFloat(internalCost) * 100).toFixed(1)}%
                      </p>
                    </div>
                  </div>
                </div>
        ...
        {step === 5 && (
          <div>
            <h2 className="text-lg font-semibold mb-2">Expected Completion</h2>
            ...
            <div className="bg-[#1F2937] border border-[#374151] rounded-xl p-4 mb-6">
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <p className="text-sm text-[#EF4444]">Rs. {parseFloat(internalCost).toLocaleString()}</p>
                </div>
          ...
          <div className="flex gap-3">
            {step > 1 && (
              <button
                ...
                className="flex-1 py-3 bg-[#374151] hover:bg-[#4B5563] rounded-xl font-semibold transition-colors"
              >
                Back
              </button>
            )}
            {step < 5 ? (
              <button
                ...
                disabled={
                  ...
                  (step === 3 && !assignedTo) ||
                  (step === 4 && (!internalCost || parseFloat(internalCost) <= 0 || (hasCustomerCharge && (!customerCharge || parseFloat(customerCharge) <= 0))))
                }
                className="flex-1 py-3 bg-gradient-to-r from-[#8B5CF6] to-[#7C3AED] rounded-xl font-semibold disabled:opacity-50 disabled:cursor-not-allowed transition-opacity"
              >
                Continue
              </button>
            ) : (
              <button
                ...
                className="flex-1 py-3 bg-gradient-to-r from-[#10B981] to-[#059669] rounded-xl font-semibold disabled:opacity-50 disabled:cursor-not-allowed transition-opacity"
              >
