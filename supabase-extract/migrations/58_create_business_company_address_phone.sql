-- ============================================================================
-- Migration 58: Extend create_business_transaction with company address, phone
-- Create Business Wizard data now saves to companies + branches for Settings
-- ============================================================================

DROP FUNCTION IF EXISTS create_business_transaction(TEXT, TEXT, TEXT, TEXT, UUID, TEXT, DATE, TEXT, TEXT);
...
BEGIN
  ...
  -- Step 1: Create company with address, phone, country, timezone
  INSERT INTO companies (
    id, name, email, currency, is_active, created_at, updated_at,
    phone, address, country, timezone
  )
  VALUES (
    gen_random_uuid(),
    p_business_name,
  ...
  -- Step 2: Create branch with address, phone (same as company for Main Branch)
...
GRANT EXECUTE ON FUNCTION create_business_transaction(TEXT, TEXT, TEXT, TEXT, UUID, TEXT, DATE, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT) TO service_role;
GRANT EXECUTE ON FUNCTION create_business_transaction(TEXT, TEXT, TEXT, TEXT, UUID, TEXT, DATE, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT) TO authenticated;
COMMENT ON FUNCTION create_business_transaction(TEXT, TEXT, TEXT, TEXT, UUID, TEXT, DATE, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT) IS 'Creates business (company, branch, user) with address, phone, country, timezone. Data appears in Settings.';
